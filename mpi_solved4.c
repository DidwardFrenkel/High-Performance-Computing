...
//Added condition for consistency. Picking numtasks that doesn't divide
// arraysize will cause larger elements to be missed in the final computation.
if (numtasks % 4 != 0 || ARRAYSIZE % numtasks != 0) {
   printf("Quitting. Number of MPI tasks must be divisible by 4 and must divide the array size.\n");
